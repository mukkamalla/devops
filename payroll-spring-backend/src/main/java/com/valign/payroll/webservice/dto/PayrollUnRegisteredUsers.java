...
@Document
public class PayrollUnRegisteredUsers implements UserDetails {
	...
	@JsonProperty
	private String confirmSubscriptionOtp;
	
	
	
	public String getConfirmSubscriptionOtp() {
		return confirmSubscriptionOtp;
	}
	public void setConfirmSubscriptionOtp(String confirmSubscriptionOtp) {
		this.confirmSubscriptionOtp = confirmSubscriptionOtp;
	}
