...
public class DayValue {
	...
	private Integer id;
	@Column
	private String dayValueName;  // values are Monday, Tuesday, Wednesday,.... Sunday
	@Column
	private Integer dayValueValue;  // value are 1, 2, 3, 4, 5, 6, 7 //meaning 
	@Column
	...
	public void setDayValueName(String dayValueName) {
		this.dayValueName = dayValueName;
	}
	public Integer getDayValueValue() {
		return dayValueValue;
	}
	public void setDayValueValue(Integer dayValueValue) {
		this.dayValueValue = dayValueValue;
	}
