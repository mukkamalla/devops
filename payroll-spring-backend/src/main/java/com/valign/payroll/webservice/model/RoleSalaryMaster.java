...
public class RoleSalaryMaster {
	...
	public String getRoleSalaryName() {
		return roleSalaryName;
	}
	public void setRoleSalaryName(String roleSalaryName) {
		this.roleSalaryName = roleSalaryName;
	}
