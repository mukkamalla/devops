...
@Entity
@Table(name = "sc")
public class CompanyLevelSalaryComponent {
	...
	@Column
	private String additionOrDeduction;
	@Column
	...
	public String getAdditionOrDeduction() {
		return additionOrDeduction;
	}
	public void setAdditionOrDeduction(String additionOrDeduction) {
		this.additionOrDeduction = additionOrDeduction;
	}
