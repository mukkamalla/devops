...
@Entity
@Table(name = "rsc")
public class RoleSalaryComponent {
	...
	@Column
	private Integer currencyId;  //FK with currrency table only if value field is flat amount
	@Column
	private String formula;  // the acutal formula if type field value is C
	@Column
	private Integer roleSalaryMasterId;  // FK on the same table rsm
	@Column
	...
	public Integer getRoleSalaryMasterId() {
		return roleSalaryMasterId;
	}
	public void setRoleSalaryMasterId(Integer roleSalaryMasterId) {
		this.roleSalaryMasterId = roleSalaryMasterId;
	}
